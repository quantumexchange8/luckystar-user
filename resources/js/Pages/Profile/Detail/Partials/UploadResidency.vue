...
const handleDropResidency = (event) => {
    isDraggingResidency.value = false;
    form.errors.residency_identity = null;
...
const validateFile = (fileInput) => {
    if (fileInput.type.startsWith("application/pdf")) {
        ...
        form.residency_identity = residencyFile.value; 
    } else {
        toast.add({
            severity: 'error',
     ...
     <div class="flex flex-col gap-5 w-full">
       <div class="flex items-center gap-5">
        ...
        <div class="flex flex-col gap-1 items-start self-stretch">
            <InputLabel for="residency_identity">{{ $t(`public.${form.document_type}` )}}</InputLabel>
            <div
                :class="[
            ...
            >
                <div
                    v-if="form.errors.residency_identity"
                ...
                <InputError :message="form.errors.residency_identity" class="text-center" />
